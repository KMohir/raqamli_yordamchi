...
async def get_support_message(message: types.Message, state: FSMContext):
    try:
        lang = db.get_lang(message.from_user.id)
        await message.answer(_('Savolingiz / Murojatingiz bizning operatorlarga yuborildi, yaqin orada sizga javob beramiz!',lang),reply_markup=ReplyKeyboardRemove())
    except:
        await message.answer('Savolingiz / Murojatingiz bizning operatorlarga yuborildi, yaqin orada sizga javob beramiz!',reply_markup=ReplyKeyboardRemove())
